...
fn thrift_add() {
    ...
    assert_eq!(
        gen::generic("add", 0, &mut payload),
        vec![
            0, 0, 0, 30, 128, 1, 0, 1, 0, 0, 0, 3, 97, 100, 100, 0, 0, 0, 0, 8, 0, 1, 0, 0, 0, 1,
            8, 0, 2, 0, 0, 0, 1, 0,
        ]
    );
}
...
fn thrift_subtract() {
    ...
    assert_eq!(
        gen::generic("calculate", 0, &mut payload),
        vec![
            0, 0, 0, 54, 128, 1, 0, 1, 0, 0, 0, 9, 99, 97, 108, 99, 117, 108, 97, 116, 101, 0, 0,
            0, 0, 8, 0, 1, 0, 0, 0, 1, 12, 0, 2, 8, 0, 1, 0, 0, 0, 15, 8, 0, 2, 0, 0, 0, 10, 8, 0,
            3, 0, 0, 0, 2, 0, 0,
        ]
    );
}
