...
mod nix {
    ...
    pub use nix::sys::socket::{sockopt, AddressFamily, SockAddr, SockType, SockLevel, InetAddr,
                               Ipv4Addr, Ipv6Addr, MSG_DONTWAIT, SOCK_NONBLOCK, SOCK_CLOEXEC,
                               accept4, bind, connect, getpeername, getsockname, getsockopt,
                               ip_mreq, ipv6_mreq, linger, listen, recvfrom, sendto, setsockopt,
                               socket, shutdown, Shutdown};
    pub use nix::sys::time::TimeVal;
    pub use nix::unistd::{read, write, dup};
}
